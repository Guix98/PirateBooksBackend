...
public class UserController {
    ...
    @RequestMapping(value = "findid",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<List<UserModel>> findid(@RequestBody String json) throws JSONException { // bearer asdasdasdasd
        ...
        return new ResponseEntity<>( this.userBl.findid(username, password), HttpStatus.OK);
    }
